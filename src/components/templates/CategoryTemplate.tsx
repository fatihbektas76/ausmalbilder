...
export default function CategoryTemplate({
  ...
  const seoText = category.seoTextLong || [
    ...
    `Alle ${catName} Ausmalbilder können direkt im Browser mit dem kostenlosen Online-Ausmaltool koloriert werden — ohne Installation oder Anmeldung. Es steht eine große Farbauswahl zur Verfügung, dazu verschiedene Pinselgrößen und Formen. Das fertige Kunstwerk kann als PNG gespeichert oder auf Pinterest, WhatsApp und Instagram geteilt werden. Alle Ausmalbilder lassen sich außerdem als PDF herunterladen und auf DIN-A4-Papier ausdrucken.`,
